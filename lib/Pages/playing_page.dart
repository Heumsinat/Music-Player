...
class PlayingPage extends StatefulWidget {
  ...
  const PlayingPage({Key key, this.song, this.songData, this.nowPlayTap}) : super(key: key);
...
class _NowPlayingState extends State<PlayingPage> {
        ...
        children: <Widget>[
          Hero(
            child: Container(
              ...
              margin: EdgeInsets.only(bottom :100.00),
